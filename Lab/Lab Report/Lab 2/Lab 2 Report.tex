...
\begin{figure}[H]
    \centering
    \subfigure[网格尺寸$n=10$]{
        \includegraphics[scale=0.09]{figure/Cube-Sphere-10.png}
    }\qquad\qquad
    \subfigure[网格尺寸$n=40$]{
        \includegraphics[scale=0.09]{figure/Cube-Sphere-40.png}
    }\qquad\qquad
    \subfigure[网格尺寸$n=100$]{
        \includegraphics[scale=0.09]{figure/Cube-Sphere-100.png}
    }
...
\begin{figure}[H]
    \centering
    \subfigure[网格尺寸$n=10$]{
        \includegraphics[scale=0.09]{figure/Cube-Torus-10.png}
    }\qquad\qquad
    \subfigure[网格尺寸$n=40$]{
        \includegraphics[scale=0.09]{figure/Cube-Torus-40.png}
    }\qquad\qquad
    \subfigure[网格尺寸$n=100$]{
        \includegraphics[scale=0.09]{figure/Cube-Torus-100.png}
    }
