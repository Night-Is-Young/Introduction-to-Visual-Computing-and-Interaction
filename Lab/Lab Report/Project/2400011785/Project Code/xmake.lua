...
target("Fluid Simulation")
    ...
    add_deps("lab-common")
    add_packages("eigen")
    add_headerfiles("src/VCX/Labs/Fluid Simulation/*.h")
    add_headerfiles("src/VCX/Labs/Fluid Simulation/*.hpp")
    add_headerfiles("src/VCX/Labs/Fluid Simulation/shaders/*.vert")
    add_headerfiles("src/VCX/Labs/Fluid Simulation/shaders/*.frag")
    add_files      ("src/VCX/Labs/Fluid Simulation/*.cpp")
    add_cxflags("/openmp")
    add_ldflags("/openmp")
    after_build(function (target)
        os.cp("src/VCX/Labs/Fluid Simulation/shaders/*", path.join(target:targetdir(), "assets", "shaders"))
    end)
    after_install(function (target)
        os.cp("src/VCX/Labs/Fluid Simulation/shaders/*", path.join(target:installdir(), "bin", "assets", "shaders"))
    end)